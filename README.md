...
- **⚡ Auto Fill** — form yang cocok dengan **profile yang di-pin** (tombol ⚡ di Daftar Profile) bisa terisi tanpa menekan Fill: mode **Tanya dulu** (toast konfirmasi di halaman, default) atau **Langsung isi** (tanpa tanya — seri skor diambil yang terakhir di-update); scoring kecocokan field dengan ambang yang bisa diatur, dan field yang sudah terisi tidak pernah ditimpa.
